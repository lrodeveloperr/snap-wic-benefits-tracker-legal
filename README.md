...
- **Android:** Limited non-personalized advertising remains optional and off by default behind the separate publisher advertising choice. The current Android version has no subscriptions or in-app purchases.
